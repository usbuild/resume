...
\address{ Nanjing University, #22 Hankou Road, 210093 \\ (+86) 152-9838-8316  \\ \href{http://lecoding.com}{http://lecoding.com} \\ 
...
\section{Technical Skills} 
   \begin{tabular}{l p{3in}}
      \bf{Operating Systems} &  Ubuntu, ArchLinux, Gentoo, CentOS \\
      \bf{Languages} &  C, Java, PHP, JavaScript, C++, Python, Bash \\
      \bf{Softwares} & Vim, Git, GDB, IntelliJ, Eclipse, Maven \\
      \bf{Frameworks} & jQuery, Yii, Backbone, Spring, Spring MVC
 \end{tabular}
...
\item My job here mainly includesdesigning the authentication for OAuth2.0 and supplying APIs for the open platform, besides some front-end development (using jQuery and Bootstrap).
