var data = {
    ...
    items: [
        ...
        {name: "经验", contents: [
            { header: "微软上海 SDET", 
              time: "2013-8 ~ 2013-10",
              content: ["SDET 实习生，方向是服务器端测试开发。", 
              "实习任务主要做 Windows Azure 的应用开发。期间开发了一个网站，类似于 WebQQ, 基于 Azure 和 .Net。提供了一个开放平台和 API 给用户二次开发，包含了一些内置的应用如即时聊天、网盘、待办事项等。",
              "在实习过程中增加了对大规模软件开发流程的了解,对软件测试过程也有了更深入的认识。"
                ].join("")
            },
            {   header: "江苏中正信息科技有限公司",
                time: "2012-7 ~ 2012-12",
