var data = {
    ...
    items:[
        {name:"技能", contents:[
            {content:"<ul><li><b>系统</b> Ubuntu, ArchLinux, CentOS</li>" +
                "<li><b>编程语言</b> C, Java, PHP, JavaScript, C++, Python, Shell</li>" +
                "<li><b>工具</b> Vim, Git, IntelliJ, Eclipse</li>" +
                "<li><b>框架</b> jQuery, Yii, Backbone, Spring</li></ul>"
            }
        ]
        },
        {name:"经验", contents:[
        ...
        {name:"项目", contents:[
            {
                ...
                content:"个人项目。使用C语言开发。旨在设计一个高性能的Web服务器，功能类似于 Nginx，截至目前版本已开发到 0.0.10。" +
                    ...
                    "性能：在虚拟机512M的内存情况下，ab 测试 1000 并发单进程处理量超过 7kqps"
            },
            {
                ...
                content:"个人项目。使用C++开发。类似于Redis，提供弱化的API接口，仅支持set,get和del，数据类型支持String，Float，List，Int，其中String是Binary Safe的。" +
                    ...
                    "另外我还开发了<a href=\"https://github.com/usbuild/php_distmem\">php_distmem</a> 作为PHP访问该数据库的C语言扩展。"
            },
            {
                header:"南大文集",
                time:"2012",
                content:"合作项目。基于YII框架。这是与学长合作的一个项目，旨在为南京大学文学爱好者提供一个单纯的交流平台。<br/>" +
                    ...
                    "<li>其它一些前端和后端琐碎工作，为别人提供RESTful接口，修改页面CSS显示等。</li></ol>"
            },
            {
            ...
            },
            {
                ...
                content:"个人项目。使用PHP开发，为了封装南京大学小百合论坛的 API 而编写的程序。由于小百合未提供API，所以我的主要工作是解析页面DOM，考虑到效率问题，我主要采用了正则匹配，最终提供合乎规范的调用接口。相关子项目如下:<br>" +
                    "<ol><li><a herf=\"https://github.com/usbuild/Lily-ME\">Lily-ME</a>: 这是一个基于jQuery Mobile的小百合移动网页版，使用了上面提供的SDK。</li>" +
                    "<li><a href=\"https://github.com/usbuild/LilyClient\">Lily-Mobile</a>: 这是一个Android版本的小百合客户端，使用了上面提供的SDK并添加的部分功能如“@”、”位置标记”等功能。</li></ol>"
            },
            {
                header:"其它项目",
                time:"2011~2013",
