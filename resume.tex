...
\item 在微软商业平台下的 CTP 部门工作，这个部门的任务主要是为 Windows Azure 和其他的一些微软服务提供支付功能。我的主要任务是编写测试用例，添加一些小的功能等。
\item 实习期间，在导师的指导下我写了一个在 Windows Azure 上运行的网站。这其实是一个开放平台，给开发者提供了众多的 API。整个网站相当于一个在网页上运行的操作系统，在这个系统上通过已有的 SDK 构建应用十分简单。
\end{itemize}
